...
def main():
    ...
    if target == "hypotheses.md":
        # El board debe existir en disco antes de escribir el .md
        ...
        # Validamos el contenido que SE ESTÁ ESCRIBIENDO (el archivo aún no existe en disco)
